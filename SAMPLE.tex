...
\newglossaryentry{@glo198-tai}{
	...
	text         = {Copiadora tai debrie},
}
\newglossaryentry{@glo199-vental}{
	name         = {Ventanilla líquida.},
	description  = {(\emph{Wet Gate}): técnica aplicada durante la duplicación de una película a través de una copiadora especialmente adaptada para eliminar rayas superficiales. Normalmente los surcos desvían luz durante la duplicación y producen líneas negras en la nueva copia fílmica. En el proceso de ventanilla líquida la película se sumerge en una solución que rellena dichas rayas a medida que cada fotograma se duplica en una nueva película},
	text         = {Ventanilla líquida},
}
...
\renewcommand{\linkpreviousname}{Ant.}
\renewcommand{\linknextname}{Sig.}
...
\begin{quote}
	\enquote{Lorem\index[concepto]{Lorem} ipsum dolor sit amet, consectetuer adipiscing elit. Ut purus elit, vestibulum ut, placerat ac, adipiscing vitae, felis. Curabitur dictum gravida mauris. Nam arcu libero, nonummy eget, consectetuer id, vulputate a, magna. Donec vehicula augue eu neque. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas}\index[onomastico]{egestas}.
\end{quote}
